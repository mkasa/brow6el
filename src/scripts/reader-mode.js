...
// ==UserScript==
// @name         Reader Mode
// @description  Uses Mozilla's Readability to display articles in clean format
// @match        *://*/*
...
(function() {
    ...
    function applyReaderMode() {
        ...
        document.head.setAttribute('data-original-head', document.head.innerHTML);
        ...
        const readerHTML = `
            <div id="reader-container">
                ...
                <div id="reader-footer">
                    <p><em>Reader Mode - Press Ctrl+U and run reader-mode.js again to exit</em></p>
                </div>
            </div>
        `;
        
        // Clear head and add minimal styles
        document.head.innerHTML = '<meta charset="UTF-8">';
        
        // Apply reader mode styling
        ...
        style.textContent = `
            ...
            #reader-content blockquote {
                border-left: 4px solid #6db3f2 !important;
